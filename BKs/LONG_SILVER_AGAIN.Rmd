...
H$ref_TD.hour <- c("AG0_60", "T00C1_60", "AU0_60", "CU0_60", "IH00C1_60")
H$ref_TD.hour.text <- c("SHFE SILVER Major 60 min", 
                        "10YR TREASURY Current 60 min", 
                        "SHFE GOLD Major 60 min", 
                        "SHFE COPPER Major 60 min", 
                        "CFFEX A50 Index Current 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("AG0", "T00C1", "AU0", "CU0", "IH00C1")
H$ref_TD.text <- c("SHFE SILVER Futures", "CFFEX 10yr Treasury", "SHFE GOLD Futures", "SHFE COPPER Futures", "CFFEX A50 Index Futures")
...
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
H$GPD.D.fit.tg1 <- gpdFit(H$GPD.D.cycle.tg1, u = 140)
H$GPD.D.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.D.fit.tg1, prob = H$prob.ind),
                           digits = 3)
##Output Table
H$GPD.H.VaRES.tg1.gg <- ggtexttable(H$GPD.H.VaRES.tg1, 
