---
title: "10yr TREASURY, A50, IRONORE, COPPER and CRUDE SPREAD"
#author: "CHENRUJIE"
#date: "2020年12月23日"
output: 
...
H$ref_TD.hour <- c("IH00C1_60", "T00C1_60", "I0_60", "CU0_60")
H$ref_TD.hour.text <- c("A50 Index Current 60 min", "10YR TREASURY Current 60 min", "DCE IRONORE Major 60 min", "SHFE COPPER Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("IH00C1", "T00C1", "I0" , "CU0")
H$ref_TD.text <- c("A50 Index Futures", "CFFEX 10yr Treasury", "DCE IRONORE Futures", "SHFE COPPER Futures")
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 0.6)
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
