...
H$ref_TD.hour <- c("CF0_60", "T00C1_60")
H$ref_TD.hour.text <- c("CZCE COTTON Major 60 min", 
                        "10yr TREASURY CURRENT 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("CF0", "T00C1")
H$ref_TD.text <- c("CZCE COTTON Futures",
