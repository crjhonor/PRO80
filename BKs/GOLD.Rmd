---
title: "GOLD, 10yr TREASURY, IRONORE, COPPER, A50 INDEX and CRUDE SPREAD"
#author: "CHENRUJIE"
#date: "2021年8月2日"
output: 
...
H$ref_TD.hour <- c("AU0_60", "T00C1_60", "I0_60", "CU0_60", "IH00C1_60")
H$ref_TD.hour.text <- c("SHFE GOLD Major 60 min", 
                        "10YR TREASURY Current 60 min", 
                        "DCE IRONORE Major 60 min", 
                        "SHFE COPPER Major 60 min", 
                        "CFFEX A50 Index Current 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("AU0", "T00C1", "I0" , "CU0", "IH00C1")
H$ref_TD.text <- c("SHFE GOLD Futures", "CFFEX 10yr Treasury", "DCE IRONORE Futures", "SHFE COPPER Futures", "CFFEX A50 Index Futures")
...
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
H$GPD.D.fit.tg1 <- gpdFit(H$GPD.D.cycle.tg1, u = 65)
H$GPD.D.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.D.fit.tg1, prob = H$prob.ind),
                           digits = 3)
##Output Table
H$GPD.H.VaRES.tg1.gg <- ggtexttable(H$GPD.H.VaRES.tg1, 
