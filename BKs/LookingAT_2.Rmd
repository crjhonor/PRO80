...
H$ref_TD.hour <- c("AG0_60", "T00C1_60", "ZN0_60", "AL0_60", "CU0_60")
H$ref_TD.hour.text <- c("SHFE SILVER 60 min", "10YR TREASURY Current 60 min", "SHFE ZNIC Major 60 min", "SHFE ALUMINUM 60 min", "SHFE COPPER Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("AG0", "T00C1", "ZN0" , "AL0", "CU0")
H$ref_TD.text <- c("SHFE SILVER Futures", "CFFEX 10yr Treasury", "SHFE ZNIC Futures", "SHFE ALUMINUM Futures", "SHFE COPPER Futures")
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 1700)
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
H$GPD.D.fit.tg1 <- gpdFit(H$GPD.D.cycle.tg1, u = 5000)
H$GPD.D.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.D.fit.tg1, prob = H$prob.ind),
                           digits = 3)
##Output Table
H$GPD.H.VaRES.tg1.gg <- ggtexttable(H$GPD.H.VaRES.tg1, 
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 20)
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
