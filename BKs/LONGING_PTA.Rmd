...
H$ref_TD.hour <- c("TA0_60", "T00C1_60", "PG0_60", "RU0_60", "IH00C1_60")
H$ref_TD.hour.text <- c("CZCE PTA Major 60 min", 
                        "10YR TREASURY Current 60 min", 
                        "DCE PETROL GAS Major 60 min", 
                        "SHFE RUBBER Major 60 min", 
                        "CFFEX A50 Index Current 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("TA0", "T00C1", "PG0" , "RU0", "IH00C1")
H$ref_TD.text <- c("CZCE TA Futures", "CFFEX 10yr Treasury", "DCE Petrol Gas Futures", "SHFE RUBBER Futures", "CFFEX A50 Index Futures")
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 550)
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
...
H$ref_TD.hour.bk.lwd <- c(rep(4, 1), rep(4, 3), rep(5, 2))
...
H$dataset_for_plot[, 1] <- H$dataset_for_plot[, 1] / 5
...
H$dataset_for_plot[, 6] <- H$dataset_for_plot[, 6] * 1
