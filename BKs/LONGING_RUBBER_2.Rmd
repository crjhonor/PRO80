...
H$ref_TD.hour <- c("RU0_60", "T00C1_60", "RB0_60")
H$ref_TD.hour.text <- c("SHFE RUBBER Major 60 min", "10YR TREASURY Current 60 min", "SHFE REBAR Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("RU0", "T00C1", "RB0")
H$ref_TD.text <- c("SHFE RUBBER Futures", "CFFEX 10yr Treasury", "SHFE REBAR Futures")
...
H$ref_TD.hour <- c("SCM_60", "I0_60")
H$ref_TD.hour.text <- c("INE SCM major 60 min", "DCE IRONORE Major 60 min")
H$ref_TD <- c("SCM", "I0")
H$ref_TD.text <- c("INE Crude Futures", "DCE IRONORE FUTURES")
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 15)
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
...
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
H$GPD.D.fit.tg1 <- gpdFit(H$GPD.D.cycle.tg1, u = 55)
H$GPD.D.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.D.fit.tg1, prob = H$prob.ind),
                           digits = 3)
##Output Table
H$GPD.H.VaRES.tg1.gg <- ggtexttable(H$GPD.H.VaRES.tg1, 
