...
H$ref_TD.hour <- c("IH00C1_60", "TA0_60")
H$ref_TD.hour.text <- c("CFFEX A50 Current 60 min", 
                        "CZCE PTA Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("IH00C1", "TA0")
H$ref_TD.text <- c("CFFEX A50 Stocks Futures",
                   "CZCE PTA Futures")
...
H$dataset_for_plot[, 2] <- H$dataset_for_plot[, 2]
