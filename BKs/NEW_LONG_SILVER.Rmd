...
H$ref_TD.hour <- c("AG0_60", "CU0_60", "ZN0_60", "AL0_60")
H$ref_TD.hour.text <- c("SHFE SILVER Major 60 min", 
                        "SHFE COPPER Major 60 min", 
                        "SHFE ZNIC Major 60 min", 
                        "SHFE ALUMINUM Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("AG0", "CU0" , "ZN0", "AL0")
H$ref_TD.text <- c("SHFE SILVER Futures", "SHFE COPPER Futures", "SHFE ZNIC Futures", "SHFE ALUMINUM Futures")
...
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
H$GPD.D.fit.tg1 <- gpdFit(H$GPD.D.cycle.tg1, u = 800)
H$GPD.D.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.D.fit.tg1, prob = H$prob.ind),
                           digits = 3)
##Output Table
H$GPD.H.VaRES.tg1.gg <- ggtexttable(H$GPD.H.VaRES.tg1, 
...
H$dataset_for_plot[, 1] <- H$dataset_for_plot[, 1] / 2
H$dataset_for_plot[, 2] <- H$dataset_for_plot[, 2] / 20
H$dataset_for_plot[, 3] <- H$dataset_for_plot[, 3] / 20
H$dataset_for_plot[, 4] <- H$dataset_for_plot[, 4] / 20
