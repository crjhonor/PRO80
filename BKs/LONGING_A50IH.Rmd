...
H$ref_TD.hour <- c("IH00C1_60", "T00C1_60")
H$ref_TD.hour.text <- c("CFFEX A50 Index CURRENT 60 min", 
                        "10yr TREASURY CURRENT 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("IH00C1", "T00C1")
H$ref_TD.text <- c("CFFEX A50 Index Futures",
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 0.40)
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
