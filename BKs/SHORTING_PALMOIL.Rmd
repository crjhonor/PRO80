---
title: "10yr TREASURY, PALMOIL, GOLD, COPPER and CRUDE SPREAD"
#author: "CHENRUJIE"
#date: "2021年2月19日"
output: 
...
H$ref_TD.hour <- c("P0_60", "AU0_60", "T00C1_60", "CU0_60")
H$ref_TD.hour.text <- c("DCE PALMOIL Major 60 min", "SHFE GOLD Major 60 min", "10YR TREASURY Current 60 min", "SHFE COPPER Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("P0" , "AU0", "T00C1", "CU0")
H$ref_TD.text <- c("DCE PALMOIL Futures", "SHFE GOLD Futures", "CFFEX 10yr Treasury", "SHFE COPPER Futures")
