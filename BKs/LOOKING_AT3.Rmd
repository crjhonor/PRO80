...
H$ref_TD.hour <- c("RU0_60", "T00C1_60", "RB0_60", "I0_60", "IH00C1_60", "SR0_60", "TA0_60", "P0_60", "M0_60", "AL0_60", "ZN0_60", "BU0_60", "FU0_60")
H$ref_TD.hour.text <- c("SHFE RUBBER Major 60 min", "10YR TREASURY Current 60 min", "SHFE REBAR Major 60 min", "DCE IRONORE Major 60 min", "CFFEX A50 Index Current 60min", "CZCE SUGAR Major 60 min", "CZCE PTA Major 60 min", "DCE PALMOIL Major 60", "DCE SOYMEAL Major 60", "SHFE Aluminum Major 60", "SHFE Znic Major 60", "SHFE BITUMAN Major 60", "SHFE Fuel Major 60")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("RU0", "T00C1", "RB0", "I0", "IH00C1", "SR0", "TA0", "P0", "M0", "AL0", "ZN0", "BU0", "FU0")
H$ref_TD.text <- c("SHFE RUBBER Futures", "CFFEX 10yr Treasury", "SHFE REBAR Futures", "DCE IRONORE", "CFFEX A50 Index Futures", "CZCE SUGAR Futures", "CZCE PTA Futures", "DCE PALMOIL Futures", "DCE SOYMEAL Futures", "SHFE Aluminum Futures", "SHFE Znic Futures", "SHFE BITUMAN Futures", "SHFE Fuel Futures")
...
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
H$GPD.D.fit.tg1 <- gpdFit(H$GPD.D.cycle.tg1, u = 1.5)
H$GPD.D.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.D.fit.tg1, prob = H$prob.ind),
                           digits = 3)
##Output Table
H$GPD.H.VaRES.tg1.gg <- ggtexttable(H$GPD.H.VaRES.tg1, 
...
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
H$GPD.D.fit.tg1 <- gpdFit(H$GPD.D.cycle.tg1, u = 150)
H$GPD.D.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.D.fit.tg1, prob = H$prob.ind),
                           digits = 3)
##Output Table
H$GPD.H.VaRES.tg1.gg <- ggtexttable(H$GPD.H.VaRES.tg1, 
...
H$ref_TD.hour.bk.lwd <- c(rep(7, 3), rep(4, 3), rep(5, 5))
H$ref_TD.hour.bk.lty <- c(rep(1, 3), rep(3, 3), rep(5, 5))
