---
title: "CN 10yr Treasury 2 CRUDE SPREAD"
#author: "CHENRUJIE"
#date: "2020年9月30日"
output: 
...
H$ref_TD.hour <- c("T00C1_60")
H$ref_TD.hour.text <- c("CFFEX 10yr Treasury Current 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("T00C1")
H$ref_TD.text <- c("CFFEX 10yr Treasury Futures")
