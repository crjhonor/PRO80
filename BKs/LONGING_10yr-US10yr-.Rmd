...
H$ref_TD.hour <- c("T00C1_60", "TY00Y_60", "AU0_60", "CU0_60", "IH00C1_60")
H$ref_TD.hour.text <- c("10YR TREASURY Current 60 min", "US 10yr Current 60 min", "SHFE GOLD Major 60 min", "SHFE COPPER Major 60 min", "CFFEX A50 Current 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("T00C1", "TY00Y", "AU0" , "CU0", "IH00C1")
H$ref_TD.text <- c("CFFEX 10yr Treasury", "US 10yr Treasury", "SHFE GOLD Futures", "SHFE COPPER Futures", "CFFEX A50 Futures")
