---
title: " COPPER, A50, 10yr TREASURY, PALMOIL, and CRUDE SPREAD"
#author: "CHENRUJIE"
#date: "2021年7月27日"
output:   
...
H$ref_TD.hour <- c("CU0_60", "IH00C1_60", "T00C1_60", "P0_60")
H$ref_TD.hour.text <- c("SHFE COPPER Major 60 min", "A50 Index Current 60 min", "10YR TREASURY Current 60 min", "DCE PALMOIL Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("CU0", "IH00C1", "T00C1", "P0")
H$ref_TD.text <- c("SHFE COPPER Futures", "A50 Index Futures", "CFFEX 10yr Treasury", "DCE PALMOIL Futures")
...
H$dataset_for_plot[, 2] <- H$dataset_for_plot[, 2] * 1
H$dataset_for_plot[, 3] <- H$dataset_for_plot[, 3] * 100
