---
title: "ALUMINUM, COPPER, 10yr TREASURY, GOLD, and CRUDE SPREAD"
#author: "CHENRUJIE"
#date: "2021年2月27日"
output: 
...
H$ref_TD.hour <- c("AL0_60", "CU0_60", "T00C1_60", "AU0_60")
H$ref_TD.hour.text <- c("SHFE ALUMINUM Major 60 min", "SHFE COPPER Major 60 min", "10YR TREASURY Current 60 min", "SHFE GOLD Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("AL0", "CU0", "T00C1", "AU0")
H$ref_TD.text <- c("SHFE ALUMINUM Futures", "SHFE COPPER Futures", "CFFEX 10yr Treasury", "SHFE GOLD Futures")
...
H$dataset_for_plot[, 2] <- H$dataset_for_plot[, 2] / 10
