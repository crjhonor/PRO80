...
H$ref_TD.hour <- c("CF0_60", "T00C1_60", "IH00C1_60", "CU0_60", "RB0_60")
H$ref_TD.hour.text <- c("CZCE COTTON Major 60 min", "10YR TREASURY Current 60 min", "CFFEX A50 Index 60 min", "SHFE COPPER Major 60 min", "SHFE REBAR Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("CF0", "T00C1", "IH00C1" , "CU0", "RB0")
H$ref_TD.text <- c("CZCE COTTON Futures", "CFFEX 10yr Treasury", "CFFEX A50 Index年 Futures", "SHFE COPPER Futures", "SHFE REBAR Futures")
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 0.5)
H$GPD.H.VaRES.tg1 <- round(gpdRiskMeasures(H$GPD.H.fit.tg1, prob = H$prob.ind),
                           digits = 3)
...
H$dataset_for_plot[, 3] <- H$dataset_for_plot[, 3] / 3
