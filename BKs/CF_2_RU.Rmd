---
title: "SPREADING: COTTON To RUBER"
#author: "CHENRUJIE"
#date: "2021年8月19日"
output: 
...
H$ref_TD.hour <- c("CF0_60", "RU0_60")
H$ref_TD.hour.text <- c("CZCE COTTON Major 60 min", "SHFE RUBBER Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("CF0", "RU0")
H$ref_TD.text <- c("CZCE COTTON Futures", "SHFE RUBBER Futures")
...
H$ref_TD.hour.bk.lwd <- c(rep(5, 2))
H$ref_TD.hour.bk.lty <- c(rep(1, 2))

##Ploting.=======================================
H$Reengineered_Dataset_Plot(H$Trends.Hourly_TD_All, 
                            H$ref_TD.hour.bk.lwd, H$ref_TD.hour.bk.lty)
```
...
H$dataset_for_plot[, 1] <- H$dataset_for_plot[, 1] * 0.1
H$dataset_for_plot[, 2] <- H$dataset_for_plot[, 2] * 0.1
