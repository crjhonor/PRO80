---
title: "PTA, A50, IRONORE, COPPER and CRUDE SPREAD"
#author: "CHENRUJIE"
#date: "2021年1月4日"
output: 
...
H$ref_TD.hour <- c("TA0_60", "IH00C1_60", "I0_60", "CU0_60")
H$ref_TD.hour.text <- c("CZCE PTA Major 60 min", "A50 Index Current 60 min", "DCE IRONORE Major 60 min", "SHFE COPPER Major 60 min")
H$ref_TD.hour.bk <- H$ref_TD.hour
H$ref_TD <- c("TA0", "IH00C1", "I0" , "CU0")
H$ref_TD.text <- c("CZCE PTA Futures", "A50 Index Futures", "DCE IRONORE Futures", "SHFE COPPER Futures")
...
##GPD
H$GPD.H.fit.tg1 <- gpdFit(H$GPD.H.cycle.tg1, u = 130)
